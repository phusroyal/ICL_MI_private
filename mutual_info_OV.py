    ...
    for idx, p in enumerate(prompt_list):
        ...
        if method == "bmi":
            for l in range(num_layer):
                QKOV_raw['V'][l] = QKOV_raw['V'][l]
                QKOV_raw['attn_output_each_head'][l] = QKOV_raw['attn_output_each_head'][l]
        ...
        get_information_by_layer = [cinfo.get_info_layer(ov_dict_list[l], args.num_bins, method) for l in tqdm(range(num_layer))]
        ...
        with open(f"data/info_17/info_17_{idx}.txt", 'w', encoding='utf-8') as f:
            json.dump(information, f, ensure_ascii=False, indent=4, default=convert_ndarray)

        info_lst.append(information)
    
    with open(f"data/info_17/info_17_total.txt", 'w', encoding='utf-8') as f:
            json.dump(information, f, ensure_ascii=False, indent=4, default=convert_ndarray)
